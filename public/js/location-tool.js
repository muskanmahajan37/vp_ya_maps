...
LocationTool.MapView = function (map) {
    ...
    this.state = new ymaps.data.Manager({
        ...
        mapZoom: map.getZoom(),
        markerPosition: $("#markerPosition").attr('value').split(',')
    });
...
LocationTool.MapView.prototype = {
    ...
    _createDraggableMarker: function () {
        ...
        console.log(data.placemarct.split(','));
        return new ymaps.Placemark( data.placemarct.split(',') , {
